    ...
    <form class="form-signin" action="save_regTracks.php" method="POST">
      <div class="text-center mb-4">
        ...
        <div class="form-label-group">
          <div class="row">
            <div class="col">
              <input type="text" id="trackName" class="form-control" placeholder="Track Name" required autofocus name="trackNames[]">
              <label for="trackName">Track Name</label>
            </div>
            <div class="col">
              <input type="text" id="length" class="form-control" placeholder="Track Length" required autofocus name="lengths[]">
